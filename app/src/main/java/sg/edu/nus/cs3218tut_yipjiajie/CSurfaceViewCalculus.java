...
public class CSurfaceViewCalculus extends SurfaceView implements SurfaceHolder.Callback  {
    ...
    class DrawThread extends Thread
    {
        ...
        public DrawThread(SurfaceHolder paramContext, Context paramHandler, Handler arg4)
        {
            ...
            // For gray box to highlight the Period
            periodBox           = new Paint();
            periodBox.setAntiAlias(true);
            periodBox.setARGB(128, 128, 128, 128);
            periodBox.setStrokeWidth(1);
        ...
        public void doDraw(Canvas canvas)
        {
            ...
            while (xStart < tutorial4.bufferSize-1) {
            ...
            // Draw Rectangle
            canvas.drawRect(0, boxHeight - 50, tutorial4.period, boxHeight + 50, periodBox);
            ...
            while (xStart < tutorial4.bufferSize-1) {
                ...
                int yStart = -tutorial4.sig1[xStart] * drawScale;
                int yStop  = -tutorial4.sig1[xStart+1] * drawScale;
            ...
            while (xStart < tutorial4.bufferSize-1) {
                ...
                int yStart = -tutorial4.productSig[xStart] * drawScale/2;
                int yStop  = -tutorial4.productSig[xStart+1] * drawScale/2 ;
